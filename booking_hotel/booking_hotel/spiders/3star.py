...
class ThreeStarSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.booking.com/searchresults.vi.html?dest_id=6228;dest_type=region;nflt=class%3D3%3B;ss=H%C3%A0%2BN%E1%BB%99i%2C%2BVi%E1%BB%87t%2BNam;tmpl=searchresults']
